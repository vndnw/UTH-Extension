...
async function registerClass(classId, classCode) {
  try {
    ...
    // Call API with idLopHocPhan as query parameter and no request body
    const response = await fetch(`${BASE_URL}/api/v1/dkhp/dangKyLopHocPhan?idLopHocPhan=${encodeURIComponent(classId)}`, {
      method: "POST",
      headers: {
